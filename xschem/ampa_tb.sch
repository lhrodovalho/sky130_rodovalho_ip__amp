...
N 1460 -400 1560 -400 { lab=x_ps}
N 1500 -540 1500 -400 { lab=x_ps}
N 1500 -540 1650 -540 { lab=x_ps}
...
C {ampa.sym} 300 -320 0 0 {name=xdut_df}
...
C {ampa.sym} 940 -320 0 0 {name=xdut_cm}
...
C {devices/lab_pin.sym} 1460 -540 2 1 {name=l39 sig_type=std_logic lab=x_ps}
