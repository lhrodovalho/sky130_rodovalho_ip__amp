...
N 520 -290 520 -170 { lab=z}
N 360 -290 360 -170 { lab=y}
N 560 -320 580 -320 { lab=ip}
N 300 -320 320 -320 { lab=im}
N 680 -110 680 -100 { lab=vss}
N 680 -140 700 -140 { lab=vss}
N 700 -140 700 -100 { lab=vss}
N 680 -100 700 -100 { lab=vss}
N 680 -540 680 -530 { lab=vdd}
N 680 -500 700 -500 { lab=vdd}
N 700 -540 700 -500 { lab=vdd}
N 680 -540 700 -540 { lab=vdd}
N 680 -320 700 -320 { lab=o}
N 540 -100 680 -100 { lab=vss}
N 540 -540 680 -540 { lab=vdd}
N 680 -470 680 -170 { lab=o}
N 500 -220 520 -220 { lab=z}
N 420 -440 620 -440 { lab=ib}
N 620 -500 620 -440 { lab=ib}
N 620 -500 640 -500 { lab=ib}
N 520 -250 600 -250 { lab=z}
N 660 -250 680 -250 { lab=o}
N 520 -200 620 -200 { lab=z}
N 620 -200 620 -140 { lab=z}
N 620 -140 640 -140 { lab=z}
C {devices/lab_pin.sym} 580 -320 2 0 {name=l16 sig_type=std_logic lab=ip}
...
C {devices/lab_pin.sym} 300 -320 2 1 {name=l5 sig_type=std_logic lab=im
}
...
C {p4_1.sym} 660 -500 0 0 {name=x4a}
C {n4_1.sym} 660 -140 0 0 {name=x4c}
C {devices/lab_pin.sym} 700 -320 2 0 {name=l11 sig_type=std_logic lab=o
}
C {devices/lab_pin.sym} 500 -220 2 1 {name=l8 sig_type=std_logic lab=z
}
C {sky130_fd_pr/cap_mim_m3_1.sym} 630 -250 3 0 {name=C1 model=cap_mim_m3_1 W=4 L=4 MF=1 spiceprefix=X}
